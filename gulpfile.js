...
gulp.task('watchScripts', ['minifyScripts', 'concatScripts'], function(){
	gulp.watch(config.js.SOURCE_DIR + '/**/*.js', ['minifyScripts', 'concatScripts']);
});
...
gulp.task('build', ['minifyScripts', 'sass', 'concatScripts']);
